...
[![Yang Recode](https://www.herokucdn.com/deploy/button.svg)](https://wa.me/6282127081926?text=Assalamualaikum)


## Join Group Diskusi
[![Grup WhatsApp](https://img.shields.io/badge/WhatsApp%20Group-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/GVwpKf83s42D1CnIfDW) 
**NO BOT**
...
$ git clone https://github.com/IkmalMtp2/OP -b multi-device
$ cd games-wabot
$ npm i 
```
...
```bash
git clone https://github.com/IkmalMtp2/OP
cd OP
npm install
npm update
```
...
// example 
conn.sendButton(m.chat, 'Hello world!', '@Ikmal', null, [
      ['Hello', 'hello'], ['Bye', 'bye']
])
// example button location
conn.sendButton(m.chat, 'Hello world!', '@Ikmal', 'https://github.com/IkmalMtp2', 
      [['Hello', 'hello'], ['Bye', 'bye']], 
...
#### Contributor
[![IkmalMtp2](https://github.com/Adiixyz.png?size=100)](https://github.com/IkmalMtp2)
